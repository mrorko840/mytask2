    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item">
                    <a href="{{route('admin.frontend.sections', 'notice')}}" class="nav-link ">
                        <i class="menu-icon far fa-bell"></i>
                ...
                <li class="sidebar-menu-item">
                    <a href="{{route('admin.frontend.sections', 'links')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Your Links')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item">
                    <a href="{{route('admin.frontend.sections', 'slider')}}" class="nav-link ">
                        <i class="menu-icon fab fa-staylinked"></i>
                        <span class="menu-title">@lang('Slider Image')</span>
                    </a>
                </li>
            ...
            <div class="text-center mb-3 text-uppercase">
                <span class="text--warning">my Task</span>
                <span class="text--success">@lang('V'){{systemDetails()['version']}} </span>
                <br>
                <span class="text--white">Designed By - <i class="fab fa-telegram-plane"></i> <a href="https://t.me/iam_mrHemel"> <b>H E M E L</b></a></span>
            </div>
        </div>
    </div>
</div>
