...
<script>
    ...
    <body>
        <nav style="z-index:10;" class="navbar navbar-dark bg-secondary p-5 mb-5">
            <div class="container">
                <div class="col-12">
                    <div id="myProgress">
                        <div id="myBar">0%</div>
                ...
                <ul class="nav navbar-nav">
                    <li class="active row">
                        ...
                        <a type="button" id="confirm" class="btn btn-secondery btn-md" disabled>
                            @lang('Loading Ads...')
                        </a>
                    </li>
                </ul>
        ...
        <script>
            ...
            var elem = document.getElementById("myBar");
                ...
                if (width >= 100) {
                var confirmButton = document.getElementById("confirm");
                        confirmButton.className = "btn btn-danger d-flex justify-content-between";
    ...
    <div id="appCapsule">    
        <div class="advertise-wrapper mt-5">
            @if($ptc->ads_type==1)
