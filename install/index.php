...
<head>
	...
	<title>Wellcome to DemoPTC Installer</title>
...
<body>
	<header class="section-bg py-2 text-center">
		<div class="container">
			<h3 class="title">Wellcome to DemoPTC Installer</h3>
		</div>
	</header>
...
";
   ...
   $stmt->execute();						
	...
	<footer class="section-bg py-3 text-center">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - Custom Modified by <a href="https://facebook.com/mrorko10">H E M E L</a></p>
		</div>
	</footer>
	<style>
		#hide{
